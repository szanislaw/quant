...
# LLM COMMENTARY
# ----------------------------
def llm_commentary(model, tokenizer, ticker, latest, confidence, decision, reasons, dte, profit_mult):
    ...
    Step 2 — Explain why quant made this call using the provided indicators.
    ...
    # 🔹 Only keep commentary starting from Step 1
            ...
            if latest["Signal"]:
                ...
                if st.session_state.sleeve >= contract_cost:
                    ...
                    commentary_text, discrepancy_flag = llm_commentary(
                        model, tokenizer, ticker, latest, confidence, decision, reasons, dte, profit_mult
                    )
